...
### Dados PMS
aux_PMS       = GET(paste("http://api.sidra.ibge.gov.br/values/t/8161/n3/33/v/11622/p/",
...
### Dados PMC
aux_PMC       = GET(paste("http://api.sidra.ibge.gov.br/values/t/8185/n3/33/v/11707/p/",
                          first_year_data,first_month_data,"-",last_year_data,last_month_data,
...
indicador_normalizadoV2 = 0.87*(0.70*iss_normalizado+0.25*pms_normalizado+0.05*pmc_normalizado)+
                          0.13*icms_normalizado
indicador_normalizadoV2 = ts(indicador_normalizadoV2, 
